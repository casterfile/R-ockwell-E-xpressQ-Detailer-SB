...
class Scene06: UIViewController ,iCarouselDelegate , iCarouselDataSource {
    var x = 0
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let IVbackground = UIImageView(image: #imageLiteral(resourceName: "Scene06.png"))
        let frame = CGRect(x: 0, y: 0, width: self.view.frame.width , height: self.view.frame.height)
        IVbackground.frame = frame
        view.addSubview(IVbackground)
        
        //Creating Carousel
        let carousel = iCarousel(frame: CGRect(x: 100, y: 530, width: 400, height: 100))
...
//        carousel.type = .coverFlow
    ...
    func carousel(_ carousel: iCarousel, viewForItemAt index: Int, reusing view: UIView?) -> UIView {
        ...
        itemView = UIImageView(frame: CGRect(x: 0, y: 0, width: 550, height: 750))
        ...
        if(x == 1){
            ...
            button.frame = CGRect(x: 400, y: 400, width: 550, height: 750)
