...
class Scene_Proscenium_03: UIViewController {
    let BackBtn = UIButton()
    let NextBtn = UIButton()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let IVbackground = UIImageView(image: #imageLiteral(resourceName: "Scene_Proscenium_03.png"))
